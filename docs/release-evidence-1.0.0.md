...
| IPA SHA-256 | `0480b56e0ed5ae495059935cf7313c31e370f9cd897827c4f99acc4c11fc936f` | Prior 2026-07-15 export: `0ba08aa4a9a502ef3907ebbf4ac367ee3d2625ed681e6001ec7f91935a389f05`; current reproducible export: `11478ace75a8b0890bc06e853e8150646221ffb095139f90d45b8dbd930f3594` |
| IPA status | Uploaded, processed, internally installed (prior audit/user evidence) | Signed App Store IPA rebuilt locally; App Store Connect upload/processing status requires dashboard verification |
...
all remain `1.0.0 (5)`. This does not prove whether build 5 already exists in
App Store Connect; the account owner must check before choosing the next upload
number.
...
| `flutter build ipa --release --export-options-plist=ios/ExportOptions.plist` | Passed; 42.7 MB IPA, 177.6 MB archive |
...
- Vercel reports the production deployment READY and no runtime error clusters
  in the inspected seven-day window as of 2026-07-23.
...
| Dependency security gate | **FAILED locally / current live unpatched** | Review and deploy Next.js 16.2.11; resolve or explicitly accept the residual bundled PostCSS/Sharp findings |
...
| App Store Connect build status | Blocked on owner | Confirm whether build 5 exists before selecting/uploading a unique build |
